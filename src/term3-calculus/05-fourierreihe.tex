...
\begin{example}
    \begin{enumerate}
        ...
        \item {
            ...
            % (*) -- получили через свертку exp:

            % $Re \sum\limits_{k=1}^{n} e^{i\cdot (2k-1)\pi} = Re e^{i\cdot \pi} \cdot \sum\limits_{k=0}$
...
\begin{remark}
    $\xi$ - случайная величина с плотностью распределения $f \geqslant 0$, тогда 
    
    $\varphi_\xi (x) = \sqrt{2\pi} \overset{\vee}{f} (x) $

    $\overset{\wedge}{f} (x) = \frac{1}{\sqrt{2\pi}} \varphi_\xi (-x)$

    т.к. $\overset{\wedge}{f} (x) = \overset{\vee}{f} (-x)$
\end{remark}

\begin{properties}
    \begin{enumerate}
        \item {
            $\overset{\wedge}{f} \in C (\mathbb{R})$ и $|\overset{\wedge}{f}(x)| \leqslant \frac{1}{\sqrt{2\pi}} ||f||_1$
            ...
            \begin{proof}
                ...
                \begin{enumerate}
                    ...
                    \item {
                        ...
                        $(*) = \left| \overset{\wedge}{f} (x + h) - \overset{\wedge}{f} (x) \right| = \frac{1}{\sqrt{2\pi}} \left| \int\limits_{\mathbb{R}} f(t) (e^{-it(x + h)} - e^{-itx}) \, dt \right| \leqslant \frac{1}{\sqrt{2\pi}} \int_{\mathbb{R}} |f(t)| |e^{-iht} - 1| \, dt \leqslant \frac{1}{\sqrt{2\pi}} \int_{\mathbb{R}} 2|f(t)| dt$

                        Нашли суммируюмую мажорнату, тогда можно под интегралом переходить к пределу:

                        $(*) \to_{h \to 0} \frac{1}{\sqrt{2\pi}} \int_{\mathbb{R}} f(t) \lim_{h \to 0} |e^{-i h t} - 1| dt = 0$.
                    }
                \end{enumerate}
            ...
            \begin{proof}
                ...
                \begin{enumerate}
                    ...
                    \item {
                        ...
                        Чтобы дифференцировать под знаком интеграла -- нужна равномерная сходимость этой величины: $t^{k-1} f(t) e^{-itx}$.

                        Равн. сх-ть есть, так как $\left| t^{k-1} f(t) e^{-itx} \right| = |t|^k |f(t)|$ -- суммируемая по условию, тогда пользуемся признаком Вейерштрасса.
                    }
                \end{enumerate}
            \end{proof}
        }
        \item {
            ...
            \begin{proof}
                ...
                Хотим показать, что левоа слагаемое равно $0$.

                $f(t) = \int\limits_0^t f' (s) \, ds \rightarrow_{t \to +\infty} \int\limits_0^\infty f' (s) \, ds \implies \lim\limits_{t \to \pm \infty} f(t)$ существует, т.к. $f'$ -- суммируема.
        ...
        \item {
            ...
            \begin{proof}
                $f(a + xh)^{\wedge} = \frac{1}{\sqrt{2\pi}} \int\limits_{\mathbb{R}} f(a + th) e^{-itx} \, dt =_{s := a + th} \frac{1}{\sqrt{2\pi}} \int\limits_{\mathbb{R}} f(s) e^{-ix \frac{s - a}{h}} \frac{ds}{h} =$
                
                $= \frac{1}{\sqrt{2\pi}} \cdot \frac{1}{h} \cdot \int\limits_{\mathbb{R}} f(s) e^{-i \frac{x}{h} s} \, ds \cdot e^{\frac{ixa}{h}} = \overset{\wedge}{f(\frac{x}{h})} \cdot \frac{1}{h} \cdot e^{\frac{i x a}{h}}$
            \end{proof}
        }
        \item {
            $\overset{\wedge}{f * g} (x) = \overset{\wedge}{f} (x) \cdot \overset{\wedge}{g} (x) \cdot \sqrt{2\pi}$
            ...
            \begin{proof}
                \begin{enumerate}
                    \item {
                        ...
                        $\xi$ и $\eta$ - независимые случайные величины с плотностью распределения $f$ и $g$ и
                        
                        $\underbrace{\varphi_{\xi + \eta}}_{\sqrt{2\pi} \overset{\wedge}{h} (x)} = \varphi_{\xi} (-x) \cdot \varphi_{\eta} (-x) = \sqrt{2\pi} \overset{\wedge}{f} (x) \cdot \sqrt{2\pi} \overset{\wedge}{g} (x)$, где
        
                        $h$ -- плотность распределения $\xi + \eta$, но $h = f * g$.
                    }
                    \item {
                        Для отрицательных функций делим их как $f = f_+ - f_-$ и работаем так.
                    }
                \end{enumerate}                
            \end{proof}
        }
        \item {
            ...
            если $\overset{\wedge}{f} (x) = \overset{\wedge}{g} (x)$, то $f = g$ почти везде
        
            
            \begin{proof}
                Если совпали характеристические функции, то совпали и случайные величины.
            \end{proof}
        }
        \item {
            \textit{Формула обращения}:
            
            пусть $f \in L^1 (\mathbb{R}), f \in C(\mathbb{R})$ и $\overset{\wedge}{f} (x) \in L^1 (\mathbb{R})$

            Тогда $f(t) = \frac{1}{\sqrt{2\pi}} \int\limits_{\mathbb{R}} \overset{\wedge}{f} (x) e^{itx} \, dx$, То есть $\overset{\vee}{\overset{\wedge}{f}} (x) = f(x)$.

            \begin{proof}
                Пусть $\overset{\wedge}{f} (x) \geqslant 0$ и $\int = 1$. Возьмём $\xi$ - случайную величину с плотностью распределения $\overset{\wedge}{f} (x)$

                Тогда умеем восстанавливать $\underbrace{P(a < \xi \leqslant b)}_{=\int\limits_a^b f(x) \, dx = (*)} = \frac{1}{2\pi} \lim\limits_{T \to +\infty} \int\limits_{-T}^T \underbrace{\varphi_{\xi} (t)}_{=\sqrt{2\pi} \overset{\wedge}{f} (-t)} \frac{e^{-ita} - e^{-itb}}{it} \, dt =$
                
                $= \frac{1}{\sqrt{2\pi}} \int\limits_{\mathbb{R}} \overset{\wedge}{f} (-t) \frac{e^{-ita} - e^{-itb}}{it} \, dt$

                Давайте продифференцируем $(*)$ по $b \, : \, f(b) = \frac{1}{\sqrt{2\pi}} \int\limits_{\mathbb{R}} \overset{\wedge}{f} (-t) e^{-itb} \, dt = \frac{1}{\sqrt{2\pi}} \int\limits_{\mathbb{R}} \overset{\wedge}{f} (s) e^{isb}\, ds$
            \end{proof}
        }
    \end{enumerate}
\end{properties}
...
\begin{example}
    ...
    Ноты -- это колебания, звук -- сумма синусов и косинусов.

    $f(t) = \sum\limits_{n = 1}^\infty a_n e^{i\lambda_n t}$ на $[-A, A]$.
    
    Ряд $\sum\limits_{n = 1}^\infty |a_n|$ сходится.
    
    Хотим вытащить ноту / отфильтровать шумы.

    $f(t) = 0$ вне $[-A, A]$

    $\overset{\wedge}{f} (x) = \frac{1}{\sqrt{2\pi}} \int\limits_{\mathbb{R}} \sum\limits_{n = 1}^\infty a_n e^{i\lambda_n t} e^{-itx} \, dt =_{\text{по Фубини, т.к. ряд сх-ся}} \frac{1}{\sqrt{2\pi}} \sum\limits_{n = 1}^\infty a_n \int\limits_{-A}^A e^{i\lambda_n t} e^{-itx} \, dt$

    \begin{enumerate}
        \item {
            Если $x = \lambda_n$, то $\int\limits_{-A}^A e^{i\lambda_n t} e^{-itx} \, dt = 2A$
        }
        \item {
            Если $x \neq \lambda_n$, то $\int\limits_{-A}^A e^{i(\lambda_n - x)t} \, dt = 2 \frac{\sin (\lambda_n - x)A}{\lambda_n - x} = \frac{e^{i (\lambda_n - x) t}}{i (\lambda_n - x)} \big|_{t = -A}^{t = A} =$

            $= \left| 2 \frac{\sin \left((\lambda_n - x)A\right)}{\lambda_n - x} \right| \leqslant \frac{1}{\lambda_n - x}$

            Если $x$ далеко от всех $\lambda_n$, то все интегралы маленькие.

            Если $x$ попал близко / в $\lambda_n$, интеграл увеличился, слагаемое $a_n \cdot \int$ -- большое, остальные маленькие.
        }
    \end{enumerate}
\end{example}
