...
\begin{theorem}
    ...
    Пусть $a$ - существенно особая точка функции $f$. Тогда $Cl f(0 < |z - a| < \varepsilon) = \mathbb{C}$ 
...
\begin{proof}
    \begin{enumerate}
        ...
        Если на найдётся, то в некоторой проколотой окретности $0 < |z - a| < \varepsilon $ $f(z) \neq b$
...
\begin{definition}
    ...
    Или же $u^2 + v^2 + w^2 = w$ - уравнение сферы.
\end{definition}
...
\begin{consequence}
    \begin{enumerate}
        \item Расстояние между образами $z$ и $ $ равно $\rho = \frac{|z - z|}{\sqrt{1 + |z|^2} \cdot \sqrt{1 + |z|^2}}$,
        а расстояние между $z$ и $\infty$ равно $\frac{1}{\sqrt{1 + |z|^2}}$

        \textbf{Доказательство:} $\rho^2 $ TODO
...
\begin{theorem}
    ...
    Тогда $\int_{\delta K} f(z) \, dz = 2\pi i \sum_{k = 1}^n \res_{z = a_k} f(z)$ 
\end{theorem}
...
\begin{proof}
    ...
    Из интегральной формулы Коши: $\int_{\delta \widetilde{K}} f(z) \, dz = 0$

    Но $\int_{\delta \widetilde{K}} f(z) \, dz = \int_{\delta K} f(z) \, dz - \sum_{k = 1}^n \int_{|z - a_k| = \varepsilon} f(z) \, dz$, а 
...
\begin{consequence}
    ...
    Но также $\int_{|z| = R} f(z) \, dz = -2 \pi i \res_{z = \infty} f(z)$. Перекидываем и доказываем.
\end{consequence}
