...
\begin{example}
    \begin{enumerate}
        ...
        \item {
            ...
            $\res_{a_k} f = \frac{1}{(z^{2n} + 1)'} \big|_{z = a_k} = \frac{1}{2n \cdot a_k^{2n - 1}} = \frac{a_k}{2na_k^{2n}} = -\frac{a_k}{2n}$.
        }
        \item {
...
\begin{example}
    ...
    $ \underbrace{\int_{C_{\varepsilon}} f(z) \, dz \rightarrow -\pi i res_{z = 0} f = -\pi i}_{\text{Лемма о полувычете $\alpha=\pi$, $\beta=0$ - т.к. обход в другую сторону}}$
...
\begin{example}
    ...
    \begin{enumerate}
        ...
        \item $\int_{Re^{2\pi i}}^{\varepsilon e^{2 \pi i}} = \int_{R}^{\epsilon} \frac{e^{(p-1)\cdot (ln(z) + 2\pi i)}}{1 + x}dx = e^{2\pi i \cdot (p-1)} \cdot (-1)\cdot \int_{\epsilon}^{R} \rightarrow -e^{(p - 1) \pi i} \cdot I$
        \item {
            $\left | \int_{C_{R}} \frac{e^{(p - 1)Ln z}}{1 + z} \, dz \right | \leqslant 2\pi R \cdot \max \left | \frac{e^{(p - 1) Ln z}}{1 + z} \right | =
            2\pi R \cdot \frac{R^{p - 1}}{\min |1 + z|} = 2\pi R \cdot \frac{R^{p - 1}}{R - 1} \rightarrow 0$

        }
        \item {
            $\left | \int_{C_{\varepsilon}} \frac{e^{(p - 1)Ln z}}{1 + z} \, dz \right | \leqslant 2\pi \varepsilon \cdot \max \left | \frac{e^{(p - 1) Ln z}}{1 + z} \right | =
            2\pi \varepsilon \cdot \frac{\varepsilon^{p - 1}}{\min |1 + z|} = 2\pi \varepsilon \cdot \frac{\varepsilon^{p - 1}}{1 - \varepsilon} \rightarrow 0$
        }

        Получили в итоге $I = \pi \frac{2i e^{(p - 1)\pi i}}{1 - e^{(p - 1)2\pi i}} = \pi \frac{2i}{e^{-\pi i(p-1)} - e^{\pi i(p - 1)}} = \pi \frac{2i}{e^{\pi i p} - e^{-\pi i p}} = \frac{\pi}{\sin \pi p}$
    \end{enumerate}
\end{example}
