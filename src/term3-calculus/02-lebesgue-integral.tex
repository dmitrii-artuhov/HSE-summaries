...
\begin{properties}
    \begin{enumerate}
        ...
        \item {
            ...
            \begin{proof}
                $\mathbbm{1}_{E_k} |f| \leq \mathbbm{1}_E |f| \leq \sum_{k=1}^{n} \mathbbm{1}_{E_k} |f| \implies \int_{E_k}{|f| d \mu} \leq \sum_{k=1}^{n} \int_{E_k}{|f| d \mu}$.
                
                Если $E = \bigsqcup_{k=1}^{n} E_k$, то $\mathbbm{1}_E = \sum_{k=1}^{n} \mathbbm{1}_{E_k} \implies \mathbbm{1}_E f_{\pm} = \sum_{k=1}^{n} \mathbbm{1}_{E_k} f_{\pm} \implies \int_E{f_{\pm} d \mu} = \sum_{k=1}^{n} \int_{E_k}{f_{\pm} d \mu}$
            \end{proof}
        }
        \item {
