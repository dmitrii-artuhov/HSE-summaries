...
\begin{proof}
    ...
    \begin{itemize}
        \item [Шаг 1.] {
            ...
            $\lambda_m \Phi \left(\Omega \cap G_k\right) = \int_{\Omega \cap G_k}{|J_{\Phi}| d \lambda_m}$ и просуммируем $\Omega \cap \left( G_k \setminus \bigcup_{j = 1}^{k - 1} G_j \right)$.
        }
        \item [Шаг 2.] {
        ...
        \item [Шаг 3.] {
            ...
            Эти значения стремят в тем, что выше, соответственно.
...
\begin{example}
    ...
    $\int_{\mathbb{R}^2}{f d \lambda_2} = \int_{[0, 2 \pi] \times [0, +\infty)} {f(r \cos{(\phi)}, r \sin{(\phi)})} d r d \phi$.
