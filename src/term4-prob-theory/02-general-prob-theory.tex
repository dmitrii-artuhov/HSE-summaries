...
\begin{definition}
    Случайная величина имеет абсолюнто непрерывное распределение, если 
    существует $p_{\xi} (t) \geqslant 0$, измеримая, т.ч. $F_{\xi} (x) = 
    \int_{-\infty}^x p_{\xi} (t) \, dt$
\end{definition}

\begin{properties}
    \begin{enumerate}
        \item {
            $P_{\xi} (A) = \int_{A} p_{\xi} (t) \, dt$
...
\begin{example}
    ...
    \begin{enumerate}
        ...
        \item {
            ...
            $\xi : \Omega \to [a, b]$. $p_{\xi}(t) = \frac{1}{b - a} \cdot \mathbb{1}_{[a, b]} (t)$
        }
        \item {
        ...
        \item {
            ...
            $\xi : \Omega \to [0, +\infty]$. $p_{\xi}(t) = \lambda e^{-\lambda t}$ при $t \geqslant 0$. В других точках 0.
        }
    \end{enumerate}
