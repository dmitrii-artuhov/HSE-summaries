...
\begin{theorem}
    ...
    $|P(\frac{S_n - np}{\sqrt{npq}} \leqslant x) - \Phi (x)| \leqslant \frac{p^2 + q^2}{\sqrt{npq}} \cdot \frac{1}{2}$
...
\begin{example}
    ...
    $P(a_n = k) = P(S_n = \frac{n + k}{2}) = 0$, если $n \not \equiv k \mod 2$

    $P(a_n = k) = P(S_n = \frac{n + k}{2}) = \binom{n}{\frac{n + k}{2}} p^{\frac{n + k}{2}} q^{\frac{n - k}{2}}$, если $n \equiv k \mod 2$, иначе
\end{example}
